...
// v1.2.3N - CSS 3D Rubik's Cube with internal state + full 6-face moves (no animation)
// - Face mapping adjusted: R->old F, F->old L, L->old B, B->old R (U/D unchanged)
// - B and D direction flipped (to match user's observation in this viewer coordinate system)
...
(function () {
  ...
  // --- NOTE: B and D were flipped per user report in this viewer's coordinate system ---
  // We implement B as previous "prime" direction and B' as previous "base" direction, same for D.
  function moveB() {
    // (flipped) previously B'
