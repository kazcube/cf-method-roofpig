...
// v1.2.4N - CSS 3D Rubik's Cube with internal state + full 6-face moves (no animation)
// - Face mapping adjusted: R->old F, F->old L, L->old B, B->old R (U/D unchanged)
// - D direction flipped (per earlier observation). B is WCA-standard in v1.2.4N.
...
(function () {
  ...
  // --- NOTE: D was flipped per earlier report. B is WCA-standard in v1.2.4N ---
